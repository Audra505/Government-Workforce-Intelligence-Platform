...
// Department list filter bar — Client Component.
// Drives URL search params for search (name/code/description) and status filter.
// Must be wrapped in <Suspense> on the server side (useSearchParams requirement).
// Reference: governance/GD-M25-1.md — Decision 2, 12
...
export function DepartmentFilters({ total }: Props) {
