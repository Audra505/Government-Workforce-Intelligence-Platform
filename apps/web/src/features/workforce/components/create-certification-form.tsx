...
import { z } from 'zod';
import type { CreateCertificationBffResponse } from '@/features/workforce/types';
...
export function CreateCertificationForm() {
  ...
  const {
    ...
    defaultValues: { expirationRequired: false },
  });
  ...
  async function onSubmit(values: FormValues) {
    ...
    if (values.issuer) payload.issuer = values.issuer;
    ...
    const json = (await res.json()) as CreateCertificationBffResponse;
    if (json.success) {
