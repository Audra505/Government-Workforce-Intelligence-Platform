...
// M21C: VacancyStatusDot, PriorityBadge, AgingCell per GD-M21-1 D10.
// M23: Pill status, outlined priority badge, table shadow/radius per mockup.
        ...
        <table className="w-full text-sm">
          <thead>
            <tr style={{ borderBottom: '1px solid #e2e8f0' }}>
              <th className="px-4 py-2.5 text-left uppercase" style={TH_STYLE}>Position</th>
              ...
              <th className="px-4 py-2.5 text-left uppercase" style={TH_STYLE}>Priority</th>
              <th className="px-4 py-2.5 text-left uppercase" style={TH_STYLE}>Age</th>
              <th className="px-4 py-2.5 text-left uppercase" style={TH_STYLE}>Expected Fill</th>
