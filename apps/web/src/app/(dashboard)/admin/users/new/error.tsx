...
// Error boundary for the /admin/users/new route segment.
...
// Reference: apps/web/src/app/(dashboard)/admin/departments/new/error.tsx — same pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while loading the create user form. Please try again.
          </p>
