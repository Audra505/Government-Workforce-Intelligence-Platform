...
// Error boundary for the /admin/departments/[id]/edit route segment.
// Must be a Client Component — Next.js App Router requirement for error.tsx.
// Cannot import AdminShell (Server Component) — minimal navy header inlined.
// Reference: apps/web/src/app/(dashboard)/workforce/positions/[id]/edit/error.tsx — shell pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while loading the edit department form. Please try again.
          </p>
