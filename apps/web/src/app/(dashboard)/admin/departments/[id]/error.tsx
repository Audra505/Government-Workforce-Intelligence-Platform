...
// Error boundary for the /admin/departments/[id] route segment.
...
// Reference: apps/web/src/app/(dashboard)/workforce/positions/[id]/error.tsx — shell pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while fetching department data. Please try again.
          </p>
