...
// Error boundary for the /admin/departments/new route segment.
...
// Reference: apps/web/src/app/(dashboard)/workforce/positions/new/error.tsx — shell pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while loading the create department form. Please try again.
          </p>
