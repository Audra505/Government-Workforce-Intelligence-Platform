...
// Error boundary for the /oversight/audit route segment.
// Must be a Client Component — Next.js App Router requirement for error.tsx.
// Cannot import OversightShell (Server Component) — minimal navy header inlined.
// Reference: apps/web/src/app/(dashboard)/admin/users/error.tsx — shell pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while fetching audit data. Please try again.
          </p>
