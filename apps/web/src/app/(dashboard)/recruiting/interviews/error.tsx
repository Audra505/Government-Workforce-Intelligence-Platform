...
// Error boundary for the Interviews route segment.
...
// A minimal dark-header shell is inlined here, consistent with candidates/error.tsx pattern.
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while fetching interview data. Please try again.
          </p>
