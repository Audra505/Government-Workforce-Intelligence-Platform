...
// Error boundary for the Applications route segment.
// Must be a Client Component — Next.js App Router requirement for error.tsx.
// Cannot import Server Components (including RecruitingShell) from a Client Component.
// A minimal dark-header shell is inlined here, matching the candidates/error.tsx pattern.
// Reference: apps/web/src/app/(dashboard)/recruiting/candidates/error.tsx — pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while fetching application data. Please try again.
          </p>
