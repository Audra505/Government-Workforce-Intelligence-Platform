...
// Error boundary for the Candidates route segment.
// Must be a Client Component — Next.js App Router requirement for error.tsx.
// Because error.tsx is a Client Component, it cannot import Server Components
// (including RecruitingShell). A minimal dark-header shell is inlined here.
// Reference: apps/web/src/app/(dashboard)/workforce/vacancies/error.tsx — pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while fetching candidate data. Please try again.
          </p>
