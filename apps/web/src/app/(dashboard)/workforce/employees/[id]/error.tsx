...
// Error boundary for the /workforce/employees/:id route segment.
// Catches ApiError thrown by EmployeeDetailPage when GET /api/v1/employees/:id returns non-404 errors.
// 404 responses use notFound() and do not reach this boundary.
...
// Reference: apps/web/src/app/(dashboard)/recruiting/candidates/error.tsx — shell pattern
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            This employee record could not be loaded. You may not have permission to view it.
          </p>
