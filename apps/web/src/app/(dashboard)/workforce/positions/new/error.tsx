...
// Error boundary for the /workforce/positions/new route segment.
...
export default function NewPositionError({
  error,
  reset,
}: {
      ...
      >
        <div>
          ...
          <p className="mt-1 text-sm" style={{ color: '#475569' }}>
            An error occurred while loading the create position form. Please try again.
          </p>
