// BFF POST handler — reject application.
// Browser endpoint: POST /api/recruiting/applications/:id/reject
// Backend target:   POST /api/v1/applications/:id/reject  (200, returns updated application)
//
// No request body — NestJS reject endpoint takes no body.
// Terminal action: sets application status to REJECTED; cannot be undone.
//
...
// Reference: apps/api/src/recruiting/application.controller.ts — POST /applications/:id/reject (line 365)
...
export async function POST(
  ...
  try {
    nestRes = await fetch(`${apiUrl}/api/v1/applications/${id}/reject`, {
      method: 'POST',
      headers: {
