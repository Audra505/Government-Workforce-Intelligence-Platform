// BFF POST handler — cancel an interview.
// Browser endpoint: POST /api/recruiting/interviews/:id/cancel
// Backend target:   POST /api/v1/interviews/:id/cancel  (200, returns updated interview)
//
// No request body — NestJS cancel endpoint takes no body.
// Terminal action: sets interview status to CANCELLED; cannot be undone.
//
...
// Reference: apps/api/src/recruiting/interview.controller.ts — POST /interviews/:id/cancel (line 408)
...
export async function POST(
  ...
  try {
    nestRes = await fetch(`${apiUrl}/api/v1/interviews/${id}/cancel`, {
      method: 'POST',
