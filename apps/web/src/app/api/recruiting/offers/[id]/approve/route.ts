// BFF POST handler — approve a PENDING_APPROVAL offer.
// Browser endpoint: POST /api/recruiting/offers/:id/approve
// Backend target:   POST /api/v1/offers/:id/approve  (200, transitions PENDING_APPROVAL → APPROVED)
//
// No request body — NestJS approve endpoint takes no body.
...
// Reference: apps/api/src/recruiting/offer.controller.ts — POST /offers/:id/approve (line 350)
...
export async function POST(
  ...
  try {
    nestRes = await fetch(`${apiUrl}/api/v1/offers/${id}/approve`, {
      method: 'POST',
